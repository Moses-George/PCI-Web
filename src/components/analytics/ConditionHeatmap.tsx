      ...
      <MapContainer center={[37.78, -122.41]} zoom={11} style={{ height: '400px', width: '100%' }} className="z-0">
        ...
        <div className="leaflet-bottom leaflet-right" style={{ zIndex: 1000 }}>
          <div className="bg-white p-2 rounded shadow-md text-xs">
            <div><span className="inline-block w-3 h-3 bg-green-500 mr-1"></span> Good (85-100)</div>
            <div><span className="inline-block w-3 h-3 bg-blue-500 mr-1"></span> Satisfactory (70-84)</div>
            <div><span className="inline-block w-3 h-3 bg-yellow-500 mr-1"></span> Poor (55-69)</div>
            <div><span className="inline-block w-3 h-3 bg-orange-500 mr-1"></span> Very Poor (40-54)</div>
            <div><span className="inline-block w-3 h-3 bg-red-500 mr-1"></span> Failed (0-39)</div>
          </div>
        </div>
      </MapContainer>
    </div>
